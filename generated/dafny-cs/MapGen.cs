// Dafny program MapGenLogging.dfy compiled into C#
...
// Command-line arguments: build --target cs specs/logging/MapGenLogging.dfy --output generated/dafny-cs/MapGen.Logging
// MapGenLogging.dfy
...
module {:extern ""MapGen.Logging""} MapGenLogging {
  ...
  datatype LogLevel = Trace | Debug | Info | Warn | Error

  datatype LogEvent = LogEvent(ts: int, stage: string, job_id: string, level: LogLevel, event: string, msg: string, kv: map<string, string>)
  ...
  class LogContract {
    ...
    {
      NonEmpty(name) &&
      forall i: int {:trigger name[i]} :: 
        0 <= i < |name| ==>
          (name[i] >= 'a' && name[i] <= 'z') || (name[i] >= '0' && name[i] <= '9') || name[i] == '_'
    }
  }
}
")]
...
// end of class FuncExtensions
namespace MapGen.Logging {

  public partial class __default {
    public static bool NonEmpty(Dafny.ISequence<Dafny.Rune> s) {
      return (new BigInteger((s).Count)).Sign == 1;
    }
    public static bool LooksLikeUuid(Dafny.ISequence<Dafny.Rune> s) {
      return (((((new BigInteger((s).Count)) == (new BigInteger(36))) && (((s).Select(new BigInteger(8))) == (new Dafny.Rune('-')))) && (((s).Select(new BigInteger(13))) == (new Dafny.Rune('-')))) && (((s).Select(new BigInteger(18))) == (new Dafny.Rune('-')))) && (((s).Select(new BigInteger(23))) == (new Dafny.Rune('-')));
    }
    public static bool Valid(MapGen.Logging._ILogEvent e) {
      return ((((((e).dtor_ts).Sign != -1) && (MapGen.Logging.__default.NonEmpty((e).dtor_stage))) && (MapGen.Logging.__default.LooksLikeUuid((e).dtor_job__id))) && (MapGen.Logging.__default.NonEmpty((e).dtor_event))) && (MapGen.Logging.__default.NonEmpty((e).dtor_msg));
    }
  }

  public interface _ILogLevel {
    bool is_Trace { get; }
    bool is_Debug { get; }
    bool is_Info { get; }
    bool is_Warn { get; }
    bool is_Error { get; }
    _ILogLevel DowncastClone();
  }
  public abstract class LogLevel : _ILogLevel {
    public LogLevel() {
    }
    private static readonly MapGen.Logging._ILogLevel theDefault = create_Trace();
    public static MapGen.Logging._ILogLevel Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<MapGen.Logging._ILogLevel> _TYPE = new Dafny.TypeDescriptor<MapGen.Logging._ILogLevel>(MapGen.Logging.LogLevel.Default());
    public static Dafny.TypeDescriptor<MapGen.Logging._ILogLevel> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ILogLevel create_Trace() {
      return new LogLevel_Trace();
    }
    public static _ILogLevel create_Debug() {
      return new LogLevel_Debug();
    }
    public static _ILogLevel create_Info() {
      return new LogLevel_Info();
    }
    public static _ILogLevel create_Warn() {
      return new LogLevel_Warn();
    }
    public static _ILogLevel create_Error() {
      return new LogLevel_Error();
    }
    public bool is_Trace { get { return this is LogLevel_Trace; } }
    public bool is_Debug { get { return this is LogLevel_Debug; } }
    public bool is_Info { get { return this is LogLevel_Info; } }
    public bool is_Warn { get { return this is LogLevel_Warn; } }
    public bool is_Error { get { return this is LogLevel_Error; } }
    public static System.Collections.Generic.IEnumerable<_ILogLevel> AllSingletonConstructors {
      get {
        yield return LogLevel.create_Trace();
        yield return LogLevel.create_Debug();
        yield return LogLevel.create_Info();
        yield return LogLevel.create_Warn();
        yield return LogLevel.create_Error();
      }
    }
    public abstract _ILogLevel DowncastClone();
  }
  public class LogLevel_Trace : LogLevel {
    public LogLevel_Trace() : base() {
    }
    public override _ILogLevel DowncastClone() {
      if (this is _ILogLevel dt) { return dt; }
      return new LogLevel_Trace();
    }
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogLevel_Trace;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "MapGenLogging.LogLevel.Trace";
      return s;
    }
  }
  public class LogLevel_Debug : LogLevel {
    public LogLevel_Debug() : base() {
    }
    public override _ILogLevel DowncastClone() {
      if (this is _ILogLevel dt) { return dt; }
      return new LogLevel_Debug();
    ...
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogLevel_Debug;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "MapGenLogging.LogLevel.Debug";
      return s;
    }
  }
  public class LogLevel_Info : LogLevel {
    public LogLevel_Info() : base() {
    }
    public override _ILogLevel DowncastClone() {
      if (this is _ILogLevel dt) { return dt; }
      return new LogLevel_Info();
    ...
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogLevel_Info;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "MapGenLogging.LogLevel.Info";
      return s;
    }
  }
  public class LogLevel_Warn : LogLevel {
    public LogLevel_Warn() : base() {
    }
    public override _ILogLevel DowncastClone() {
      if (this is _ILogLevel dt) { return dt; }
      return new LogLevel_Warn();
    ...
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogLevel_Warn;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "MapGenLogging.LogLevel.Warn";
      return s;
    }
  }
  public class LogLevel_Error : LogLevel {
    public LogLevel_Error() : base() {
    }
    public override _ILogLevel DowncastClone() {
      if (this is _ILogLevel dt) { return dt; }
      return new LogLevel_Error();
    ...
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogLevel_Error;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "MapGenLogging.LogLevel.Error";
      return s;
    }
  }

  public interface _ILogEvent {
    bool is_LogEvent { get; }
    BigInteger dtor_ts { get; }
    Dafny.ISequence<Dafny.Rune> dtor_stage { get; }
    Dafny.ISequence<Dafny.Rune> dtor_job__id { get; }
    MapGen.Logging._ILogLevel dtor_level { get; }
    Dafny.ISequence<Dafny.Rune> dtor_event { get; }
    Dafny.ISequence<Dafny.Rune> dtor_msg { get; }
    Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> dtor_kv { get; }
    _ILogEvent DowncastClone();
  }
  public class LogEvent : _ILogEvent {
    public readonly BigInteger _ts;
    public readonly Dafny.ISequence<Dafny.Rune> _stage;
    public readonly Dafny.ISequence<Dafny.Rune> _job__id;
    public readonly MapGen.Logging._ILogLevel _level;
    public readonly Dafny.ISequence<Dafny.Rune> _event;
    public readonly Dafny.ISequence<Dafny.Rune> _msg;
    public readonly Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> _kv;
    public LogEvent(BigInteger ts, Dafny.ISequence<Dafny.Rune> stage, Dafny.ISequence<Dafny.Rune> job__id, MapGen.Logging._ILogLevel level, Dafny.ISequence<Dafny.Rune> @event, Dafny.ISequence<Dafny.Rune> msg, Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> kv) {
      this._ts = ts;
      this._stage = stage;
      this._job__id = job__id;
      this._level = level;
      this._event = @event;
      this._msg = msg;
      this._kv = kv;
    }
    public _ILogEvent DowncastClone() {
      if (this is _ILogEvent dt) { return dt; }
      return new LogEvent(_ts, _stage, _job__id, _level, _event, _msg, _kv);
    }
    public override bool Equals(object other) {
      var oth = other as MapGen.Logging.LogEvent;
      return oth != null && this._ts == oth._ts && object.Equals(this._stage, oth._stage) && object.Equals(this._job__id, oth._job__id) && object.Equals(this._level, oth._level) && object.Equals(this._event, oth._event) && object.Equals(this._msg, oth._msg) && object.Equals(this._kv, oth._kv);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._ts));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._stage));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._job__id));
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._kv));
      return (int) hash;
    }
    public override string ToString() {
      string s = "MapGenLogging.LogEvent.LogEvent";
      s += "(";
      s += Dafny.Helpers.ToString(this._ts);
      s += ", ";
      s += this._stage.ToVerbatimString(true);
      s += ", ";
      s += this._job__id.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._level);
      s += ", ";
      s += this._event.ToVerbatimString(true);
      s += ", ";
      s += this._msg.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._kv);
      s += ")";
      return s;
    }
    private static readonly MapGen.Logging._ILogEvent theDefault = create(BigInteger.Zero, Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, MapGen.Logging.LogLevel.Default(), Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Map<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.Empty);
    public static MapGen.Logging._ILogEvent Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<MapGen.Logging._ILogEvent> _TYPE = new Dafny.TypeDescriptor<MapGen.Logging._ILogEvent>(MapGen.Logging.LogEvent.Default());
    public static Dafny.TypeDescriptor<MapGen.Logging._ILogEvent> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ILogEvent create(BigInteger ts, Dafny.ISequence<Dafny.Rune> stage, Dafny.ISequence<Dafny.Rune> job__id, MapGen.Logging._ILogLevel level, Dafny.ISequence<Dafny.Rune> @event, Dafny.ISequence<Dafny.Rune> msg, Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> kv) {
      return new LogEvent(ts, stage, job__id, level, @event, msg, kv);
    }
    public static _ILogEvent create_LogEvent(BigInteger ts, Dafny.ISequence<Dafny.Rune> stage, Dafny.ISequence<Dafny.Rune> job__id, MapGen.Logging._ILogLevel level, Dafny.ISequence<Dafny.Rune> @event, Dafny.ISequence<Dafny.Rune> msg, Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> kv) {
      return create(ts, stage, job__id, level, @event, msg, kv);
    }
    public bool is_LogEvent { get { return true; } }
    public BigInteger dtor_ts {
      get {
        return this._ts;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_stage {
      get {
        return this._stage;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_job__id {
      get {
        return this._job__id;
      }
    }
    public MapGen.Logging._ILogLevel dtor_level {
      get {
        return this._level;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_event {
      get {
        return this._event;
      }
    }
    ...
    public Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.Rune>> dtor_kv {
      get {
        return this._kv;
      }
    }
  ...
  public partial class LogContract {
    ...
    public static void RequireValid(MapGen.Logging._ILogEvent e)
    {
    }
    public static bool IsReasonableEventName(Dafny.ISequence<Dafny.Rune> name) {
      return (MapGen.Logging.__default.NonEmpty(name)) && (Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_name) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_name).Count)), true, (((_forall_var_0) => {
        BigInteger _1_i = (BigInteger)_forall_var_0;
        return !(((_1_i).Sign != -1) && ((_1_i) < (new BigInteger((_0_name).Count)))) || ((((((_0_name).Select(_1_i)) >= (new Dafny.Rune('a'))) && (((_0_name).Select(_1_i)) <= (new Dafny.Rune('z')))) || ((((_0_name).Select(_1_i)) >= (new Dafny.Rune('0'))) && (((_0_name).Select(_1_i)) <= (new Dafny.Rune('9'))))) || (((_0_name).Select(_1_i)) == (new Dafny.Rune('_'))));
      }))))(name));
    }
  }
} // end of namespace MapGen.Logging
namespace _module {
